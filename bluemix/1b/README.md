...
## Objective
This tutorial helps you get started quickly with **API Connect**. We'll start by creating a new OpenAPI spec, and then proxy existing REST services used by the sample weather app.
...
3. In API Connect, make sure the navigation panel is open. If not, click **>>** to open it.  
